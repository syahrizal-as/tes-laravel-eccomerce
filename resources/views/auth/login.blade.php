            ...
            <div class="w-px-400 mx-auto">
                ...
                <div class="app-brand mb-4">
                    <a href="index.html" class="app-brand-link gap-2 mb-2">
                        ...
                        <span class="app-brand-text demo h3 mb-0 fw-bold">Hyundai</span>
                    </a>
                </div>
                <!-- /Logo -->
                <h4 class="mb-2">Welcome to Hyundai! 👋</h4>
                ...
                <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3 form-password-toggle">
                        <div class="d-flex justify-content-between">
                            <label class="font-weight-bold mb-2 " for="password">Password</label>
