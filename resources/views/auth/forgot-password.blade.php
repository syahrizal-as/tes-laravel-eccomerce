        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
                <div class="flex-row text-center mx-auto">
                    <img src="../../assets/img/pages/verify-email-light.png" alt="Auth Cover Bg color" width="520"
                        class="img-fluid authentication-cover-img" data-app-light-img="pages/verify-email-light.png"
                        data-app-dark-img="pages/verify-email-dark.png" />
                    <div class="mx-auto">
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-4 p-sm-5">
                <div class="w-px-400 mx-auto">
                    ...
                    <a class="btn btn-primary w-100 my-3" href="javascript:void(0);"> Skip for now </a>
                    <p class="text-center">
                        Didn't get the mail?
