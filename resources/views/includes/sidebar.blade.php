<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="/" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">Hyundai</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        @if (auth()->user()->can('roles.index') ||
            ...
            <li
                class="menu-item {{ setActive('dashboard/role*') . setActive('dashboard/permission*') . setActive('dashboard/user*') }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <ul class="menu-sub">
                    @can('roles.index')
                        <li class="menu-item {{ setActive('dashboard/role*') }}">
                    ...
                    @can('permissions.index')
                        <li class="menu-item {{ setActive('dashboard/permission*') }}">
                    ...
                    @endcan
                    @can('users.index')
                        <li class="menu-item {{ setActive('dashboard/user*') }}">
